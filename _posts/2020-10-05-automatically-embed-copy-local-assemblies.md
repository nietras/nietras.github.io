...
---
REPOST: Of an old blog post from 
...
However, none of these show how pdb-files can be embedded as well to ensure symbols are also loaded when resolving embedded assemblies as detailed in [Embedded Assembly Loading with support for Symbols and Portable Class Libraries in C#](http://www.codingmurmur.com/2014/02/embedded-assembly-loading-with-support.html).  
