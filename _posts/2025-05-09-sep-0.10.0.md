---
layout: post
title: Sep 0.10.0 - 21 GB/s CSV Parsing on AMD 9950X using SIMD 🚀
---
...
too. Note that there can be ~5% variation in the numbers, so for a given release
Sep might see minor regressions.
