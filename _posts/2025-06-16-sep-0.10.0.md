...
M1](https://en.wikipedia.org/wiki/Apple_M1)) or the Microsoft cloud [Cobalt
...
as I have no ARM64 hardware myself.
...
ready for SIMD C# code, x64 SIMD assembly and tons of benchmark numbers.


Not having any ARM64 PC myself also means adding a specific parser for this
presented new challanges, as I could neither test or debug the code directly nor
