...
self respecting developers. Personally I have assembled more than 50 PCs both
for personal use and for work. That is quite a lot and is because at one point
I assembled industrial PCs for work myself due to quality issues with previous PCs.
Those issues were mainly resolved by selecting quality components for industrial use,
not so much due to my PC assembly skills, but it was a critical issue at the time. 
I have always enjoyed selecting components for and assembling a PC, though. 
...
every time though 😅 Good news is it has newer been easier to assembly a PC.
...
Jeff Atwood's [Building a PC](https://blog.codinghorror.com/building-a-pc-part-ix-downsizing/) series this post, thus, explores selecting components for a core
