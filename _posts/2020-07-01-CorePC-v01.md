...
---
Assembling your own developer PC is for many a rite of passage for any 
self respecting developer. Good news is it has newer been easier.
...
cards that are being revealed [tomorrow](https://www.nvidia.com/da-dk/geforce/special-event/).
...
format and fixed sparsity support for machine learning. This means this
blog post won't be going into detail in actually assembling the PC.
...
is a newer of the case next to me right now. It's designed for 
...
server CPU 550W should be more than enough for most. It may last you 10 years though,
so keep that in mind and perhaps opt for getting a PSU with some headroom 
for the years to come.

Here I picked the [Corsair RM550x 550W](https://www.corsair.com/eu/en/Categories/Products/Power-Supply-Units/Power-Supply-Units-Advanced/RMx-Series/p/CP-9020177-EU)
...
#### CPU Cooler
For CPU coolers I have on rule: **it must be screw mounted**. 
I have seen my share of push-pin coolers getting lose during 
transportation or similar. Crappy stock coolers should be 
avoided as much as possible. Noisy sh*t.
...
SK hynix Gold P31 1TB SSD which isn't available yet, but overall the 
SX8200 Pro is comparable and most importantly it is way cheaper than the otherwise
great Samsung 970 EVO Plus by up to 40%!
